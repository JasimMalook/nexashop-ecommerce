            ...
            <div class="col-lg-10 col-xl-8">
                <div class="login-container">
                    ...
                    <div class="login-body">
                        ...
                        <form method="POST" action="admin_login_fixed.php" novalidate>
                            <div class="mb-3">
                        ...
                        <div class="credentials-box">
                            ...
                            <div class="text-center mt-3">
                                <a href="../fix_admin.php" class="btn btn-outline-danger btn-sm">
                                    <i class="fas fa-tools me-2"></i>Fix Admin Account
                                </a>
                            </div>
                        </div>
                    </div>
